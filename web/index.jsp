...
<div align="center" class="border">
  <form>
    <input id="coeffA" name="coeffA" type="number" placeholder="A" required><b>*X<sup>2</sup>+</b>
    <!--pattern="/^-?[0-9]+$/"-->
    <input id="coeffB" name="coeffB" type="number" placeholder="B" required> <b>*X<!--<sup>1</sup>-->+</b>
    <input id="coeffC" name="coeffC" type="number" placeholder="C" required> <b>= 0</b>
    <hr/>
